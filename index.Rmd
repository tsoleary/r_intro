...
## Alternative resources
  ...
  - [R for data science](https://r4ds.had.co.nz/index/){target="_blank"} -- a wonderfully thorough and useful book that emphasizes the tidyverse
...
You can make more complicated statements with the addition of else
...
There are a bunch of resources out there that store publicly available data in a useful format -- check out [Google Dataset Search](https://datasetsearch.research.google.com/){target="_blank"}.
